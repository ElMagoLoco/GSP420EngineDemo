...
public:
	void init() {
 		menuSpriteIDs.push_back(GFX->loadSprite(L"..\\EngineDemo\\Content\\Sprites\\missile.jpg"/*L"..\\EngineDemo\\Content\\Sprites\\Background.png"*/));
...
// 		gameSpriteIDs.push_back(GFX->loadSprite(L"Content\\Sprites\\missile.png", D3DXVECTOR3(320, 400, 0.0f)));
//  		gameSpriteIDs.push_back(GFX->loadSprite(L"Content\\Sprites\\healthBackground.png", D3DXVECTOR3(350, 400, 0.0f)));
// 		gameSpriteIDs.push_back(GFX->loadSprite(L"Content\\Sprites\\healthBar.png", D3DXVECTOR3(350, 400, 0.0f)));
